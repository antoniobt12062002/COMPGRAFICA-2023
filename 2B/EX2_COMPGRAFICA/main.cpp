...
void Camera::applyTransformations() {
    glLoadIdentity();
    gluLookAt(eye.EixoX, eye.EixoY, eye.EixoZ,
              eye.EixoX + n.EixoX, eye.EixoY + n.EixoY, eye.EixoZ + n.EixoZ,
              v.EixoX, v.EixoY, v.EixoZ);
}
...
void Camera::set(Vertice Eye, Vertice Look, Vertice Up) {
    ...
    n.normalize();
    u.normalize();
    v = Vertice(n.cross(u)); // Corrigido (era 'v.set')
